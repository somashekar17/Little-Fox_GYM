...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>LittleFox - Free Fitness Site</title>
			...
			<div class="wrap-container">
				<div class="crumbs">
					<ul>
						...
						<li><a href="about.php" color="black">About</a></li>
					</ul>
				</div>
				<!-----------------Content-Box-------------------->
				<div id="main-content">
							...
							<article class="single-post zerogrid">
								<div class="row wrap-post"><!--Start Box-->
									<div class="entry-header">
										<span class="time">Sep 3, 2022  by admin</span>
							...
							<div class="zerogrid">
								<div class="comments-are">
									<div id="comment">
										...
										<form name="comment_form" id="comment_form" method="post" action="comment.php">
											<label>
											<span>Comment:</span>
